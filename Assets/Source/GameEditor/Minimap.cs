...
namespace Assets.Source.GameEditor
{
    public class Minimap
    {
        ...
        public Minimap(RawImage mapImage, RawImage markerImage, Texture2D mapTexture)
        {
            ...
            _markerStartPos = markerImage.rectTransform.position;
        ...
        {
            Vector2 size = _markerImage.rectTransform.sizeDelta;

            x /= size.x;
            z /= size.y;

            _markerImage.rectTransform.localPosition = new Vector3(size.x - x, z);
        }
